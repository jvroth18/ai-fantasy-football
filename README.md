...
The responsive front office guides first-run team creation, keeps every team independently switchable, and exposes rules, strategy, roster, draft, waiver, trade, schedule, audit, and safety workspaces. The interface has no external font or analytics dependency.
